...
#define _WIN32_WINDOWS 0x0600 // Attribuez la valeur appropriée à cet élément pour cibler Windows Me ou version ultérieure.
#endif
...
#include <afxinet.h>         // Composants Web

#include <comdef.h>         // Erreur BDD
